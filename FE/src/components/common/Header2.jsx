...
// Adjust this path to where you saved the component I gave you earlier:
              ...
              <div className="col-lg-12">
                <div className="main-haeder-wrapper-h2">
                  <Link to="/" className="logo-area">
                    <img
                      src="Header1.png"      // ✅ correct case + public/ root path
                      alt="Sabhapokhari Hydropower"
                      style={{ height: "auto" }} // avoid width="150%"
                    />
                  </Link>
                  ...
                  <div className="header-nav main-nav-one">
                    <nav>
                      <ul>
                        ...
                        {/* Use template's dropdown class for styling */}
                        <li className="has-dropdown">
                          {/* keep anchor for CSS targeting but prevent default */}
                  ...
                  <div className="actions-area">
                    ...
                    <a href="tel:+977-9851363591" className="rts-btn btn-primary">
                      Call for help: +977-9851363591
                    </a>
                  </div>
